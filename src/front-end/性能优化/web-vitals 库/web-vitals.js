var e, n, t, r, i, o = -1, a = function(e) {
  ...
  "hidden" === document.visibilityState && m > -1 && (m = "visibilitychange" === e.type ? e.timeStamp : 0,
    T());
}, y = function() {
  ...
  n = n || {},
    C(function() {
      ...
      o && (t = d(e, i, b, n.reportAllChanges),
        a(function(r) {
          i = f("FCP"),
  ...
  n = n || {},
    S(v(function() {
      ...
      u && (t = d(e, r, L, n.reportAllChanges),
        p(function() {
          c(u.takeRecords()),
            t(!0);
        }),
  ...
  e.interactionId || "first-input" === e.entryType) {
    ...
    if (t || F.length < 10 || e.duration > n.latency) {
      if (t)
        e.duration > t.latency ? (t.entries = [e],
  ...
  n = n || {},
    C(function() {
      ...
      var r, i = f("INP"), o = function(e) {
        e.forEach(H);
        var n, t = (n = Math.min(F.length - 1, Math.floor(R() / 50)),
          F[n]);
      ...
      c && ("PerformanceEventTiming"in self && "interactionId"in PerformanceEventTiming.prototype && c.observe({
        type: "first-input",
        buffered: !0
      }),
        p(function() {
  ...
  G(function() {
    ...
    i && (t.value = Math.max(i.responseStart - u(), 0),
      ...
      a(function() {
        t = f("TTFB", 0),
          (r = d(e, t, z, n.reportAllChanges))(!0);
      }));
  });
}, K = {
  passive: !0,
  capture: !0
}, Q = new Date(), U = function(e, i) {
  n || (n = i,
    t = e,
    r = new Date(),
...
}, Y = [100, 300], Z = function(e, r) {
  r = r || {},
    C(function() {
      var o, c = E(), u = f("FID"), l = function(e) {
        e.startTime < c.firstHiddenTime && (u.value = e.processingStart - e.startTime,
          u.entries.push(e),
          o(!0));
      }, m = function(e) {
        e.forEach(l);
...
export {L as CLSThresholds, b as FCPThresholds, Y as FIDThresholds, q as INPThresholds, N as LCPThresholds, z as TTFBThresholds, w as onCLS, S as onFCP, Z as onFID, O as onINP, _ as onLCP, J as onTTFB};
